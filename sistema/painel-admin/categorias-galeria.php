<?php 
$pagina = 'categorias-galeria';
require_once("verificar.php");
?>
<a href="index.php?pag=<?php echo $pagina ?>&funcao=novo" type="button" class="btn btn-secondary mt-2 mb-4">Nova Categoria</a>
...
<small>
	<table id="example" class="table table-hover table-sm my-4" style="width:98%;">
		...
		<tbody>
			<?php 
			$query = $pdo->query("SELECT * FROM categoria_img order by id desc");
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						if(@$_GET['funcao'] == 'novo'){
							...
							$id = @$_GET['id'];
							$query = $pdo->query("SELECT * FROM categoria_img WHERE  id = '$id'");
							$res = $query->fetchAll(PDO::FETCH_ASSOC);
							$nome = @$res[0]['nome'];
						}
						?>
