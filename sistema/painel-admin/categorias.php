		...
		<tbody>
			...
			for($i=0; $i < @count($res); $i++){
				...
				<tr>
					...
					<td>
						<a href="index.php?pag=<?php echo $pagina ?>&funcao=editar&id=<?php echo $id_reg ?>" title="Editar Categoria">
							<i class="bi bi-pencil-square mr-1 text-primary"></i></a>
							<a href="index.php?pag=<?php echo $pagina ?>&funcao=excluir&id=<?php echo $id_reg ?>" title="Excluir Categoria">
				...
				<div class="modal-content">
					...
					<form method="post" id="form-excluir">
						<div class="modal-body">
							...
							<span class="mb-2">Deseja Realmente Excluir esta Categoria?</span>
							<br><br>
