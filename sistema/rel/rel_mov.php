...
<body>
	...
	<div class="container">
		...
		<div align="center" class="">	
			<span class="titulorel">RELATÓRIO DE MOVIMENTAÇÕES <?php echo mb_strtoupper($status_serv)  ?> </span>
		</div>
	...
	<section class="area-tab">
						...
						<div class="linha-cab">
							<div class="coluna" style="width:20%"><b>Tipo</b></div>
							<div class="coluna" style="width:30%"><b>Descrição</b></div>
							<div class="coluna" style="width:15%"><b>Valor</b></div>
							<div class="coluna" style="width:20%"><b>Funcionário</b></div>
			...
			for ($i=0; $i < @count($res); $i++) { 
				...
				<div class="coluna" style="width:20%"><img src="<?php echo $url ?>sistema/img/<?php echo $foto ?>" width="13px"> <?php echo $tipo ?></div>	
