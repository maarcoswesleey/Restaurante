...
<body>
	...
	<section class="area-tab">
						...
						<div class="linha-cab">
							<div class="coluna" style="width:15%"><b>Total</b></div>
							<div class="coluna" style="width:15%"><b>Data</b></div>
							<div class="coluna" style="width:30%"><b>Gerente</b></div>
							<div class="coluna" style="width:25%"><b>Fornecedor</b></div>
							
							<div class="coluna" style="width:15%"><b>Pago</b></div>
			...
			for ($i=0; $i < @count($res); $i++) { 
				...
				<div class="coluna" style="width:30%"><?php echo $nome_usu ?> </div>
				<div class="coluna" style="width:25%"><?php echo $nome_forn ?> </div>
				
				<div class="coluna" style="width:15%"><img src="<?php echo $url ?>sistema/img/<?php echo $foto ?>" width="13px"> </div>
