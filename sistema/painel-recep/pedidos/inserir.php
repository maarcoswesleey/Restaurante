...
$query = $pdo->prepare("INSERT INTO pedidos SET mesa = :mesa,  obs = :obs, funcionario = :funcionario, data = curDate(), garcon = :garcon, comissao = '$comissao', couvert = '$couvert', pago = 'Não'");
