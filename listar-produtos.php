		...
		<li>
			<div class="media">
				<div class="media-left">
					<a href="#">
						<img class="media-object" src="sistema/img/produtos/{$imagem}" alt="img">
					</a>
				</div>
				<div class="media-body">
					<h4 class="media-heading"><a href="#">{$nome}</a></h4>
	...
	<div class="col-md-{$total_de_colunas}">
		<li>
			<div class="media">
				<div class="media-left">
					<a href="#">
						<img class="media-object" src="sistema/img/pratos/{$imagem}" alt="img">
					</a>
				</div>
				<div class="media-body">
					<h4 class="media-heading"><a href="#">{$nome}</a></h4>
